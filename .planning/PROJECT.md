...
---
*Last updated: 2026-06-23 after v2.0 Phase 4 (Dual Metrics and Feedback) complete — closes the v2.0 milestone (METRICS-01..03 validated; 3 live human-UAT items pending). Prior: v2.0 Phase 3 (Slips-Only Bankroll) complete — bankroll rebased to a slips-only basis from 2026-06-08 (BANKROLL-01..04 validated). Prior: v1.0 Stability Hardening milestone close — archived to milestones/, tagged v1.0 (17/17 plans, 16/16 requirements validated; audit status tech_debt, no blockers)*
